$(document).ready(function() {
  for (var i = 0; i < projects.length; i++) {
    ...
    for (var j = 0; j < projects[i]["Personal Projects"].length; j++) {
      ...
      studentName.appendChild(document.createTextNode(projects[i]["Personal Projects"][j][0]));
    ...
    for (var g = 0; g < projects[i]["Group Projects"].length; g++) {
      ...
      groupName.appendChild(document.createTextNode(projects[i]["Group Projects"][g][0]));
