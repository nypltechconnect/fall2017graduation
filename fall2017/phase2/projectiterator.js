$(document).ready(function() {
  for (var i = 0; i < projects.length; i++) {
    ...
    cohortInstructor.appendChild(
      document.createTextNode("Instructor: " + projects[i]["Instructor"])
    );
    ...
    for (var j = 0; j < projects[i]["Personal Projects"].length; j++) {
      ...
      studentLink.setAttribute("href", projects[i]["Personal Projects"][j][1]);
      ...
      studentName.appendChild(
        document.createTextNode(projects[i]["Personal Projects"][j][0])
      );
    ...
    for (var g = 0; g < projects[i]["Group Projects"].length; g++) {
      ...
      groupLink.setAttribute("href", projects[i]["Group Projects"][g][1]);
      ...
      groupName.appendChild(
        document.createTextNode(projects[i]["Group Projects"][g][0])
      );
